...
public class CLogin {
    ...
    //metodo
     public String validaUsuario(JTextField usuario, JPasswordField contrasenia){
        ...
        final String defaultAdminHash = "$2y$10$E9nPo.Eys2SbkDXOiv1sEuLT4Va2eG5n0UZANUeAFX3K8t1Bz88.i";
            ...
            try (PreparedStatement ps = conn.prepareStatement(sql)) {
                ...
                try (ResultSet rs = ps.executeQuery()) {
                    if (rs.next()) {
                        ...
                        if (!valido && defaultAdminHash.equals(storedHash) && "admin123".equals(inputPassword)) {
                            valido = true;
