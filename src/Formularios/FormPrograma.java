...
public class FormPrograma extends JFrame {

    private final CProgramas dao = new CProgramas();
    ...
    public FormPrograma() {
        setTitle("Mantenimiento de Programas");
    ...
    private void initComponents() {
        ...
        btnGuardar.addActionListener(e -> {
            dao.insertarPrograma(txtCodigo, txtNombre);
            cargarTabla();
            limpiarCampos();
        });
        ...
        btnActualizar.addActionListener(e -> {
            ...
            dao.actualizarPrograma(txtId, txtCodigo, txtNombre);
            cargarTabla();
            limpiarCampos();
        });
    ...
    private void cargarTabla() {
        dao.cargarTablaProgramas(tabla);
    }
